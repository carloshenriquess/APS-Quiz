 ...
 * @author Admin
 */
public class StopForm extends javax.swing.JFrame {

    /**
     * Creates new form EndForm
     * @param points pontos ganhos na partida
     * @param pulos pulos ganhos na partida
     * @param tips dicas usadas na partida
     */
    public StopForm(int points, int pulos, int tips) {
        initComponents();
        int totalPulos = storage.Storage.PULOS;
        int totalTips = storage.Storage.TIPS;
        this.lbPoints.setText(String.valueOf(points));
        this.lbPulos.setText(String.valueOf(totalPulos - pulos));
        this.lbTips.setText(String.valueOf(totalTips - tips));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Você escolheu parar");
